...
| **F3 spec** | New roadmap item [v1-url-namespace.md](v1-url-namespace.md) — namespace `/admin` + `/api` under `/v1/**` so customer slugs can never collide with platform routes. M effort, queued, 3 open questions. |
