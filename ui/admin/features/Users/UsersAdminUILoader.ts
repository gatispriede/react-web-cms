/**
 * Users admin pane. Mounted at `/admin/people/users` under the System area.
 *
 ...
 * side-imported so the `people/users` bridge registers at load.
 */
...
const UsersPaneDispatch: React.FC = () =>
    React.createElement(AdminPageDispatch, {paneId: 'people/users'});
