...
export const ADMIN_ITEM_TYPE_EDITORS: readonly AdminItemTypeEntry[] = [
    ...
    {key: EItemType.LargeGallery,      Editor: LargeGalleryEditor,      styleEnum: asEnum(ELargeGalleryStyle), styleLabels: LARGE_GALLERY_STYLE_LABELS,    defaultContent: '{"title":"","images":[]}',                                                                                                                                                  labelKey: 'Large gallery',        descriptionKey: 'Image-led full-bleed gallery; mobile carousel. Premium / Lookbook templates.', category: 'media'},
