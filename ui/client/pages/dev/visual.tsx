...
const VisualSlot = () => {
    ...
    const {type, editor, style, sample} = router.query as Record<string, string | undefined>;
    ...
    if (editor === '1') {
        ...
        return (
            <div data-testid="visual-slot" data-mode="editor" data-type={type} style={{padding: 24, maxWidth: 720}}>
    ...
    const {Display} = entry;
    return (
        <div data-testid="visual-slot" data-mode="display" data-type={type} data-style={styleVal} style={{padding: 24}}>
