'use client';
/**
 * Client view for `/admin/signin` — App Router migration, Batch 6.
 * Direct lift of the visible chrome from `pages/admin/signin.tsx`.
 */
...
const AdminSignInView: React.FC<{returnTo: string; googleEnabled: boolean}> = ({returnTo, googleEnabled}) => {
