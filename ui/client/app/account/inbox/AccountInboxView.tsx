'use client';
/**
 * Client view for `/account/inbox` — App Router migration, Batch 5.
 */
...
interface AccountInboxViewProps {
    systemPage: ISystemPageSnapshot | null;
}

const AccountInboxView: React.FC<AccountInboxViewProps> = ({systemPage}) => {
...
export default AccountInboxView;
