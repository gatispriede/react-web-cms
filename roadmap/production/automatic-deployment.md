...
New `src/frontend/pages/api/health.ts`:
...
- `src/frontend/pages/api/health.ts` (new)
- `src/frontend/pages/admin/welcome.tsx` (new)
- `src/frontend/components/Admin/WelcomeWizard.tsx` (new)
